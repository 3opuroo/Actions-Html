    ...
    let result = await fetchWithTimeout(
      `https://chatbot.mn/api/document/contract/generate`,
      {
        ...
        body: JSON.stringify({
          ...
          customerRD: param.customerRD.value,
          customerLast: param.customerLast.value,
          customerFirst: param.customerFirst.value,
          customerNum: param.customerNum.value,
          customerAddress: param.customerAddress.value,
          ...
          servicePayment: param.servicePayment.value,
          office:
