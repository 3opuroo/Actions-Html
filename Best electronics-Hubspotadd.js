const executeCode = async () => {
    ...
    try {
      let result = await fetchWithTimeout(
        `https://api.hubapi.com/contacts/v1/lists/all/contacts/recent?hapikey=1c5db04c-cc12-4e92-8f1a-2d2753c8c946`,
        {
          headers: {
      ...
      if (newid) {
        ...
        await fetchWithTimeout(
          `https://api.hubapi.com/contacts/v1/contact/vid/${fbid.vid}/profile?hapikey=1c5db04c-cc12-4e92-8f1a-2d2753c8c946`,
          {
            headers: {
              "Content-type": "application/json",
            },
