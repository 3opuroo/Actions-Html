    ...
    let result = await fetchWithTimeout(
      `https://chatbot.mn/api/document/contract/generate`,
      {
        ...
        body: JSON.stringify({
          ...
          office:
            "Хаяг: Улаанбаатар хот, Сүхбаатар дүүрэг<br />8-р хороо, city tower, 2 давхарт 203тоот<br />Холбоо барих: 72728000",
          ...
          thirdMonth: moment(param.contractDate.value)
            ...
            .set("date", pDay)
            .format("YYYY.MM.DD"),
          fourthMonth: moment(param.contractDate.value)
            .add(3, "M")
            .set("date", pDay)
            .format("YYYY.MM.DD"),
          fifthMonth: moment(param.contractDate.value)
            .add(4, "M")
            .set("date", pDay)
            .format("YYYY.MM.DD"),
          sixthMonth: moment(param.contractDate.value)
            .add(5, "M")
            .set("date", pDay)
            .format("YYYY.MM.DD"),
          ...
          fourthRemain: numberWithCommas(sum - paymentToNum * 4),
          fifthRemain: numberWithCommas(sum - paymentToNum * 5),
          sixthRemain: numberWithCommas(sum - paymentToNum * 6),
